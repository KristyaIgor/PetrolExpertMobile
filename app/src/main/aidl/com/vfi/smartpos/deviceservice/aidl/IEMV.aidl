...
interface IEMV {
	...
	*/
    ...
    /**
     * set smart card request online after Application Selection.
     *
    ...
    */
    ...
    /**
     * set before startEMV(), set callback for
     * @since 2.20.3.12
     */
    ...
    /**
     * select kernel version before startEMV(), pls refer CTLSKernelID
	 * @param kernelID:
	 * <pre>
