package md.intelectsoft.petrolexpert.emvcardreader.enums;
...
public enum EmvCardScheme {
	...
	DKV("DKV", "^704310198821[0-9]{5,}", "A0 00 00 06 68 00 00 00 00 02 76"), //
	NOVOFLEET("NOVOFLEET", "^704310198821[0-9]{5,}", "A0 00 00 06 68 00 00 00 01 02 76"); //
...
//	private final Pattern pattern;
	...
	public static EmvCardScheme getCardTypeByAid(final String pAid) {
		EmvCardScheme ret = EmvCardScheme.DKV ;
		if (pAid != null) {
			String aid = StringUtils.deleteWhitespace(pAid);
			for (EmvCardScheme val : EmvCardScheme.values()) {
				Log.d("PetrolExpert_BaseApp", "getCardTypeByAid: " + val.getName());
