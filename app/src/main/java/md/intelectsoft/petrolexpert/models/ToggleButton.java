package md.intelectsoft.petrolexpert.models;
...
public class ToggleButton extends View {
    ...
    private int magnification = 4, animationTime = 200;
    private int val;
    ...
    private void init() {
        ...
        changeBitmapColor.setStrokeWidth(40);
        ...
        changeBitmapColor1.setStrokeWidth(20);
