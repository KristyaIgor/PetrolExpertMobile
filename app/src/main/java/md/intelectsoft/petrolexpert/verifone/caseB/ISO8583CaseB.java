package md.intelectsoft.petrolexpert.verifone.caseB;
    ...
    static int [][] FIELD_ATTRIBUTE_ARRAY =
            {
                    ...
                    {	TYPE_BCD + TYPE_FILL_ZERO_LEFT	,	12, 0, 0	},	// field	4
