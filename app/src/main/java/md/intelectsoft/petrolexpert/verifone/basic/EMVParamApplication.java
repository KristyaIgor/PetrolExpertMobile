package md.intelectsoft.petrolexpert.verifone.basic;
...
public class EMVParamApplication extends EMVTLVParam {
    ...
    /**
     *  Specified TAG's input by Verifone
     */
    ...
    /**
     * DKV TAG's input by Igor(IS)
     */
    public static int TAG_DKV_AID_4F0B = 0x9F06; //  "Application Identifier (AID) - card Identifies the application as described in ISO/IEC 7816-5"
    public static int TAG_DKV_APP_LBL_500F = 0x500F; // Application label


    /**
     * NOVOFLEET TAG's input by Igor(IS)
     */

    public static int TAG_NOVOFLEET_AID_4F0B = 0x4F0B; //  "Application Identifier (AID) - terminal Identifies the application as described in ISO/IEC 7816-5".
