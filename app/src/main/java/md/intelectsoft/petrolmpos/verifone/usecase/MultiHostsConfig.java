package md.intelectsoft.petrolmpos.verifone.usecase;

import android.util.Log;

import md.intelectsoft.petrolmpos.verifone.basic.HostInformation;
import md.intelectsoft.petrolmpos.verifone.basic.MultiHosts;
import md.intelectsoft.petrolmpos.verifone.caseA.ISO8583u;
import md.intelectsoft.petrolmpos.verifone.caseA.ISO8583u128;
import md.intelectsoft.petrolmpos.verifone.caseB.ISO8583CaseB;
